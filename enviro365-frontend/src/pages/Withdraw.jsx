...
export default function Withdraw({ selectedProduct }) {
  ...
  if (!selectedProduct) {
    return (
      <div className="flex items-center justify-center h-full py-stack-lg">
  ...
  const maxAllowed = selectedProduct.balance * 0.9;
  ...
  function handleAmountChange(e) {
    ...
    if (val && parseFloat(val) > maxAllowed) {
      setAmountError(`Amount exceeds the maximum of ${formatZAR(maxAllowed)} (90% of balance).`);
    }
  }
  ...
  return (
    <div className="flex items-start justify-center p-margin-mobile md:p-margin-desktop bg-surface-container-low min-h-screen">
      <div className="w-full max-w-lg">
        ...
        {/* Form card — from Stitch withdrawal screen */}
          ...
          <form className="space-y-stack-md" onSubmit={handleSubmit}>
            ...
            <div className="p-3 bg-surface-container-low border-l-4 border-secondary text-on-surface-variant">
              <p className="font-body-sm text-body-sm">
                Please note that withdrawals are processed within 3–5 business days.
